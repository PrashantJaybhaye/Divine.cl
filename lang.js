...
(function () {
  ...
  const translations = {
    es: {
      ...
      'prescription.modal.title': 'Receta Médica',
      'prescription.modal.subtitle': 'Vista previa del formato de receta médica',
      'id.modal.title': 'Fotocopia del documento de identidad',
      'id.modal.subtitle': 'Vista previa del formato de la fotocopia del documento de identidad',
      'poa.preview.modal.title': 'Poder notarial simple',
      'poa.preview.modal.subtitle': 'Vista previa del formato de poder notarial simple en dos páginas',
    ...
    en: {
      ...
      'prescription.modal.title': 'Medical Prescription',
      'prescription.modal.subtitle': 'Preview of the medical prescription format',
      'id.modal.title': 'Copy of Identity Document',
      'id.modal.subtitle': 'Preview of the identity document copy format',
      'poa.preview.modal.title': 'Simple power of attorney',
      'poa.preview.modal.subtitle': 'Preview of the simple power of attorney format (two pages)',
